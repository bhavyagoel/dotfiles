...
globalkeys = my_table.join(
    ...
    --     {description = browser1, group = "function keys"}),
    awful.key({ modkey }, "a", function () awful.util.spawn( editorgui ) end,
        {description = editorgui , group = "function keys" }),
    awful.key({ altkey }, "v", function () awful.util.spawn( editor ) end,
        {description = editor , group = "function keys" }),
    ...
    --    {description = "Atom Editor", group = "super"}),
...
--         {description = "rofi theme selector", group = "super"}),
    ...
    awful.key({ modkey1, "Shift"  }, "Escape", function() awful.util.spawn("xfce4-taskmanager") end,
        {description = "Task Manager", group = "hotkeys"}),
    ...
    awful.key({ modkey1           }, "Print", function () awful.util.spawn( "flameshot gui" ) end,
        {description = "Flameshot Snippet", group = "screenshots"}),
    awful.key({ modkey1, "Shift"  }, "Print", function() awful.util.spawn( "scrot -u 'ArcoLinux-%Y-%m-%d-%s_screenshot_$wx$h.jpg' -e 'mv $f $$(xdg-user-dir PICTURES)'" ) end,
        {description = "App Screenshot", group = "screenshots"}),
 ...
 -- Show/Hide Systray
    ...
    awful.key({ modkey, "Shift" }, "Delete", function () lain.util.delete_tag() end,
...
--     awful.key({modkey}, "r", function () awful.util.spawn("redshift-gtk -l 27.2046:77.4977") end),
...
--          properties = { callback = function (c) c.maximized = false end } },
    ...
    { rule = { class = "com.github.alainm23.planner"},
        properties = { floating = false } },
...
client.connect_signal("focus", function(c) c.border_color = "#2EFF00" end)
