...
function theme.at_screen_connect(s)
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
            ...
            spr,
            arrl_ld,
            wibox.container.background(mpris_widget() , theme.bg_focus),
            arrl_dl,
            todo_widget(),
            spr,
            arrl_ld,
            ...
            weather_widget({
                    api_key='df25889eb45bc2f3073c7ae55e1a281a',
...
--             wibox.container.background(memicon, theme.bg_focus),
            wibox.container.background(ram_widget(), theme.bg_focus),
...
--             arrl_dl,
            ...
            logout_menu_widget(),
--             logout_menu_widget{
--                 onlogout=function() awful.spawn.with_shell("awesome.quit()") end
--             }
        },
    }
end
